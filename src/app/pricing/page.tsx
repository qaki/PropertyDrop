          ...
          <div className="max-w-3xl mx-auto">
            <Card className="border-2 border-primary shadow-2xl relative overflow-hidden">
              ...
              <div className="absolute top-6 right-6">
                <Badge className="bg-primary text-white px-4 py-1.5 font-semibold shadow-lg">
              ...
              <CardHeader className="text-center pt-14 pb-8">
                ...
                <div className="mt-10">
                  <div className="flex items-baseline justify-center gap-2">
                    <span className="text-7xl font-extrabold tracking-tight text-gradient">$69</span>
                    <span className="text-2xl text-muted-foreground font-medium">/month</span>
                  </div>
                  <p className="text-sm text-muted-foreground mt-3">Billed monthly • Cancel anytime</p>
                </div>
              </CardHeader>
              ...
              <CardContent className="px-8 pb-8">
                <div className="grid sm:grid-cols-2 gap-4">
                  {features.map((feature) => (
                    <div key={feature.title} className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <CardFooter className="flex flex-col gap-4 px-8 pb-10 pt-4 border-t bg-muted/30">
                <Link href="/signup" className="w-full">
                  <Button size="lg" className="w-full text-lg py-7 shadow-xl glow-primary font-bold">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg">Everything you need to know about PropertyDrop</p>
            </div>
